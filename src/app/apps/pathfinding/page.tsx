...
import { PathfindingVisualizer } from "@/components/apps/pathfinding/PathfindingVisualizer";
            ...
            <div className="relative z-10 max-w-7xl mx-auto w-full">
                <div className="flex flex-col md:flex-row items-center justify-between mb-8 gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        <GitBranch className="w-8 h-8 text-[#ff0080]" />
                        <h1 className="text-2xl md:text-3xl font-bold text-[#ff0080]">Pathfinding Visualizer</h1>
                    </div>
                </div>
